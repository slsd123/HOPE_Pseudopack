function [Qfp, x_stencil, y_stencil, c1, c1r, c2, c2b, Top, Right] =...
...
for np = 1 : Np
    [x_n y_n] = Particle_Locate_HostCell(N0, N5, M0, M5, Xp(np), Yp(np),...
        x0, x1, y0, y1, Order);
    
    [Left Right Top Bottom] = check_stencil(x_n, y_n,...
