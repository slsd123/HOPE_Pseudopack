function [Qfp] = Interpolate_Fluid_To_Particle(N0, N5, M0, M5, NV, Index,...
...
% Here, y_n must be used because there aren't any ghost points.    
    [Qfp(:,np)] = ENO_Interpolation(NV, Order, dx, dy, x, y, Q, dPdx,...
        Xp(np), Yp(np), x_n, y_n, y_n, Left, Bottom, Top, cx, cy);
end